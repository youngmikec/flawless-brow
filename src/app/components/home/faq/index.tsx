    ...
    <>
      <section className="bg-[#fffcfa] py-24 ">
        <div className="w-11/12 md:w-10/12 mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          <div>
            <h2 className="text-xl font-bold text-[#525252] mb-2">Frequently Asked Questions</h2>
            <h3 className="text-4xl sm:text-5xl font-[cursive] text-[#a58e75] leading-tight mb-6 w-full md:w-10/12">
          ...
          <div className="space-y-4">
            <div className="bg-[#f9f1e7] rounded-lg p-4 text-sm">
              <p className="font-semibold text-[#525252] mb-8">Is brow lamination safe for everyone?</p>
            ...
            <div className="bg-[#f9f1e7] rounded-lg p-4 text-sm">
              <p className="font-semibold text-[#525252] mb-8">Can I get my brows wet after my appointment?</p>
              <p className="text-[#525252]">
            ...
            <div className="bg-[#f9f1e7] rounded-lg p-4 text-sm">
              <p className="font-semibold text-[#525252] mb-8">What’s the difference between henna and regular brow tint?</p>
              <p className="text-[#525252]">
