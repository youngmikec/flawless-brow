  ...
  return (
    <>
      <div id="gallery" className="w-11/12 md:w-10/12 mx-auto py-12 bg-white">
        ...
        <div className="flex justify-end">
          <h2 className="text-4xl sm:text-5xl mt-2 leading-tight text-[#a58e75] font-style-script">Gallery</h2>
        </div>
        <div className="flex justify-end">
          <p className="mt-6 text-[#52525B] leading-relaxed w-full md:w-7/12 font-inter">
