        ...
        `}>
          {
            ...
            <div className={`w-full flex text-left mb-1 ${labelPosition === 'left' ? 'md:text-left lg:text-left' : 'md:text-right lg:text-right'}`}>
              <label htmlFor={name} className="block w-full text-sm md:text-[13px] lg:text-[14px] lato-regular text-gray-600">
                {label}
              </label>
            </div>
          }
            ...
            <div className="flex-grow">
              {
                ...
                <p className={`lato-regular font-semibold bg-inputGray text-[12px] md:text-[14px] lg:text-[14px] ${textPosition === 'right' ? 'md:text-right lg:text-right' : 'md:text-left lg:text-left'}`}>
